...
from sqlalchemy_utils.json_api import (
    IdPropertyNotFound,
    InvalidField,
    JSONMapping,
...
class TestSimpleSelect(object):
    ...
    def test_select_correlated_expression(
        self,
        session,
        model_mapping,
        model_key,
    ...
    def test_select_correlated_expression_with_o2m_o2o(
        self,
        session,
        user_cls,
        article_cls
